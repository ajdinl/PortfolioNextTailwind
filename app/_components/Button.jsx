...
export default function Button() {
  ...
  return (
    <div className='flex flex-row items-center space-x-2 text-base lg:text-sm mb-6 justify-end dark:bg-[#252525] bg-mybackground'>
      ...
      <div
        className='w-10 h-4 flex items-center bg-gray-300 rounded-full drop-shadow-md cursor-pointer'
        onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
      >
        <div
          className={`w-5 h-5 md:w-6 md:h-6 rounded-full bg-myblue shadow-md transform transition ${
