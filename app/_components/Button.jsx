...
export default function Button() {
  ...
  return (
    <div className='flex flex-row items-center space-x-2 text-xl lg:text-sm pt-8 pb-8 mt-4 lg:mt-0 justify-end dark:bg-[#252525] bg-mybackground'>
      <div className='dark:text-[#9c9ea3] font-bold drop-shadow-md hidden lg:block'>
        Change theme to:
      </div>
